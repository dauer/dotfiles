...
syntax region mustacheTV2Comment start=/{{!!/ end=/}}/ contains=Todo,mustacheTV2Widget containedin=htmlHead
syntax match mustacheTV2Widget /^\s*\(widget\|css\|attribute\|js\)\s*;/he=e-1 containedin=mustacheTV2Comment
syntax match mustacheTV2WidgetExtra /;\s*\(class\|print\|css\|\s\)*/hs=s+1 containedin=mustacheTV2Comment
...
"syntax keyword mustacheWidget widget
"highlight mustacheWidget ctermfg=blue guifg=blue
...
" tv2 stuff
HtmlHiLink mustacheTV2Comment Special
HtmlHiLink mustacheTV2Widget Statement
HtmlHiLink mustacheTV2WidgetExtra String 
